...
2. Write a second function that takes two names as strings, simulates both of them rolling die 15 times, and returns the name of the person who "won" more rolls. Don't reroll ties this time, but don't count them as "wins". 
...
# Your 15-roll function goes here
game_of_15 <- function(person1, person2){
  roll1 <- sample(1:6, prob = c(1/8, 1/8, 1/8, 1/8, 8/8, 8/8), 15, replace = T)
  roll2 <- sample(1:6, 15, replace = T)
